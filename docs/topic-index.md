...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `search` | 🔍 Epistemic Query & Search | `FORENSICS` | [`inv-verbatim-grounding`](invariants.md#inv-verbatim-grounding), [`inv-fastmcp-datetime-serialization`](invariants.md#inv-fastmcp-datetime-serialization) | `credence audit <url>` | [CLI Scripting Guide](integrations/cli-scripting-guide.md) |
| `browse` | 📚 Curated Audit Directory | `GROUND TRUTH` | [`inv-canonical-json-ed25519`](invariants.md#inv-canonical-json-ed25519), [`inv-playwright-rendering-tests`](invariants.md#inv-playwright-rendering-tests) | `credence benchmark` | [Golden 12 Benchmark Gauntlet](tutorials/10-reusable-live-e2e-and-mesh-gauntlet.md) |
| `lensing` | 🔬 3-Tier Cognitive Lensing | `COGNITIVE ARCH` | [`inv-information-pyramid-lensing`](invariants.md#inv-information-pyramid-lensing), [`inv-verbatim-grounding`](invariants.md#inv-verbatim-grounding) | `credence audit --lens focus` | [Information Pyramid Blueprint](blueprints/information-pyramid-and-epistemic-lensing.md) |
| `score` | 📊 Suspicion Score (0.0–100.0) | `SCORING METRIC` | [`inv-topic-entropy-defense`](invariants.md#inv-topic-entropy-defense), [`inv-poes-law-satire`](invariants.md#inv-poes-law-satire) | `credence score <url>` | [Auditing Webpages & Text](walkthroughs/01-auditing-webpages-and-text.md) |
| `grounding` | 🎯 Verbatim Grounding ($G=1.0$) | `INTEGRITY` | [`inv-verbatim-grounding`](invariants.md#inv-verbatim-grounding), [`inv-canonical-json-ed25519`](invariants.md#inv-canonical-json-ed25519) | `credence audit --verify` | [The Invariant Bible](invariants.md) |
| `temporal_diff` | ⏱️ Temporal SimHash Forensics | `LINEAGE` | [`inv-bittorrent-worksharing`](invariants.md#inv-bittorrent-worksharing), [`inv-version-governance`](invariants.md#inv-version-governance) | `credence diff <url>` | [Content Evolution & Stealth Edits](lab-content-evolution.md) |
| `webcrypto` | 🧪 W3C WebCrypto Verification | `CRYPTOGRAPHY` | [`inv-canonical-json-ed25519`](invariants.md#inv-canonical-json-ed25519), [`inv-zero-build-standards`](invariants.md#inv-zero-build-standards) | `credence verify-envelope` | [Security Architecture Blueprint](blueprints/security-architecture-and-threat-model.md) |
| `dossier` | 🏛️ Publisher Epistemic Dossier | `REPUTATION` | [`inv-cloudflare-assets`](invariants.md#inv-cloudflare-assets), [`inv-version-governance`](invariants.md#inv-version-governance) | `credence dossier <domain>` | [Domain Epistemic Index Blueprint](blueprints/domain-epistemic-index-and-sourcing-forensics.md) |
| `dci` | 🏆 Domain Credence Index (DCI) | `RANKINGS` | [`inv-cloudflare-assets`](invariants.md#inv-cloudflare-assets), [`inv-progressive-disclosure`](invariants.md#inv-progressive-disclosure) | `credence dci top` | [Terminology & Ontology Lexicon](blueprints/terminology-and-ontology-lexicon.md) |
| `sifter` | 📡 Sifter Syndication Stream | `STREAMING` | [`inv-ssrf-defense`](invariants.md#inv-ssrf-defense), [`inv-4k-thinking-budget`](invariants.md#inv-4k-thinking-budget) | `credence sifter stream` | [Morning Feed Sifter Cookbook](cookbooks/morning-feed-sifter.md) |
| `taxonomies` | 📜 Canonical Rule Catalogs | `GOVERNANCE` | [`inv-verbatim-grounding`](invariants.md#inv-verbatim-grounding), [`inv-poes-law-satire`](invariants.md#inv-poes-law-satire), [`inv-fixed-taxonomies`](invariants.md#inv-fixed-taxonomies) | `credence taxonomy list` | [Taxonomy Engineering Cookbook](cookbooks/taxonomy-engineering.md) |
| `spj_ethics` | 📰 SPJ Code of Ethics | `JOURNALISM` | [`inv-verbatim-grounding`](invariants.md#inv-verbatim-grounding), [`inv-bittorrent-worksharing`](invariants.md#inv-bittorrent-worksharing) | `credence taxonomy SPJ` | [The BuzzFeed News Doctrine](../blog/the-buzzfeed-news-doctrine.md) |
| `iep_fallacies` | 🧠 IEP Logical Fallacies | `LOGICAL RIGOR` | [`inv-verbatim-grounding`](invariants.md#inv-verbatim-grounding), [`inv-topic-entropy-defense`](invariants.md#inv-topic-entropy-defense) | `credence taxonomy IEP` | [Cartel Demolition Tutorial](tutorials/08-sybil-cartel-demolition.md) |
| `deceptive_patterns` | 🛑 Deceptive UI Patterns | `CONSUMER DEFENSE` | [`inv-web-component-zero-clone`](invariants.md#inv-web-component-zero-clone), [`inv-zero-build-math`](invariants.md#inv-zero-build-math) | `credence taxonomy DEC` | [Security Threat Model](blueprints/security-architecture-and-threat-model.md) |
| `custody` | 🔐 Root Key Custody (Ed25519) | `KEY CUSTODY` | [`inv-canonical-json-ed25519`](invariants.md#inv-canonical-json-ed25519), [`inv-xml-safety`](invariants.md#inv-xml-safety) | `credence keygen` | [Key Custody & Proofs](blueprints/security-architecture-and-threat-model.md) |
| `canonical_json` | 📦 RFC 8785 Canonical JSON | `DATA INTEGRITY` | [`inv-canonical-json-ed25519`](invariants.md#inv-canonical-json-ed25519), [`inv-4way-feature-parity`](invariants.md#inv-4way-feature-parity) | `credence canonicalize` | [Security Threat Model](blueprints/security-architecture-and-threat-model.md) |
| `governance` | ⚖️ Invariant Canon Governance | `CONSTITUTION` | [`inv-mk1-eyeball`](invariants.md#inv-mk1-eyeball), [`inv-order-of-operations`](invariants.md#inv-order-of-operations), [`inv-version-governance`](invariants.md#inv-version-governance) | `credence invariants audit`| [Invariant Scalability Blueprint](blueprints/invariant-scalability-and-knowledge-governance.md) |
| `topology` | 🕸️ P2P Mesh Topology | `P2P MESH` | [`inv-byzantine-cartel-resistance`](invariants.md#inv-byzantine-cartel-resistance), [`inv-edge-canonicalization`](invariants.md#inv-edge-canonicalization) | `credence mesh status` | [P2P Mesh Consensus Blueprint](walkthroughs/03-p2p-mesh-consensus.md) |
| `byzantine` | 🛡️ Byzantine Quorum $3f+1$ | `CONSENSUS MATH` | [`inv-byzantine-cartel-resistance`](invariants.md#inv-byzantine-cartel-resistance), [`inv-galileo-rule`](invariants.md#inv-galileo-rule) | `credence mesh quorum` | [Blast Radius Containment](../blog/blast-radius-containment-in-decentralized-networks.md) |
| `gossip` | 📡 Live P2P Attestation Gossip | `GOSSIP` | [`inv-canonical-json-ed25519`](invariants.md#inv-canonical-json-ed25519), [`inv-byzantine-cartel-resistance`](invariants.md#inv-byzantine-cartel-resistance) | `credence mesh gossip` | [P2P Mesh Consensus Blueprint](walkthroughs/03-p2p-mesh-consensus.md) |
| `qi_scoring` | 🏆 5-Factor Quality Score ($Q_i$) | `NODE QUALITY` | [`inv-5factor-node-quality`](invariants.md#inv-5factor-node-quality), [`inv-empirical-expertise`](invariants.md#inv-empirical-expertise), [`inv-verbatim-grounding`](invariants.md#inv-verbatim-grounding) | `credence mesh score` | [Sybil Cartel Demolition Tutorial](tutorials/08-sybil-cartel-demolition.md) |
| `vitals` | 👤 Scale-to-Zero Node Vitals | `COMPUTE PLANE` | [`inv-hermetic-testing`](invariants.md#inv-hermetic-testing), [`inv-dense-workstation-viewport`](invariants.md#inv-dense-workstation-viewport) | `credence doctor` | [Cloud Run Scale-to-Zero Blueprint](blueprints/cloudrun-scale-to-zero-cold-start-optimization.md) |
| `telemetry` | 🩺 Telemetry Loopback Protocol | `TELEMETRY` | [`inv-xml-safety`](invariants.md#inv-xml-safety), [`inv-dense-workstation-viewport`](invariants.md#inv-dense-workstation-viewport) | `credence telemetry` | [Node & Mesh Telemetry Blueprint](blueprints/node-and-mesh-telemetry-dashboard.md) |
| `badges` | 🛡️ Anti-Tamper Dynamic Badges | `ATTESTATIONS` | [`inv-web-component-zero-clone`](invariants.md#inv-web-component-zero-clone), [`inv-verbatim-grounding`](invariants.md#inv-verbatim-grounding) | `credence badge generate` | [Embeddable Badges Blueprint](blueprints/embeddable-attestation-badges-and-anti-tamper.md) |
| `seeds` | 🌱 P2P Bootstrap Discovery | `DISCOVERY` | [`inv-canonical-json-ed25519`](invariants.md#inv-canonical-json-ed25519), [`inv-byzantine-cartel-resistance`](invariants.md#inv-byzantine-cartel-resistance) | `credence mesh seeds` | [Mesh Quickstart Tutorial](tutorials/05-mesh-quickstart.md) |
