...
| :--- | :--- | :--- |
| **Composite Weight ($W_i$)** | $W_i = 0.20 Q_i + 0.80 E_{i, \text{domain}}$ | [The Invariant Bible](../invariants.md#invariant-17) (Anti-Diploma) |
| **Galileo Override** | $G=1.00 \land W_i \ge 0.70 \implies \text{is\_outlier} = \text{False}$ | [The Invariant Bible](../invariants.md#invariant-27) (Galileo Rule) |
| **Sybil Resistance** | Requires domain entropy across $\ge 5$ distinct FQDNs | [The Invariant Bible](../invariants.md#invariant-28) ($3f+1$ Cartel Defense) |
| **Slashing Penalty** | $W_i \leftarrow 0.50 W_i$ on ungrounded findings | [The Invariant Bible](../invariants.md#invariant-22) (Hallucination Slash) |
