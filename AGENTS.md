...
- **Continuous Changelog & 7-Manifest Semantic Version Governance**: Diligently maintain `docs/changelog.md` and query repository tags (`git tag -l | sort -V | tail`) prior to drafting changelogs, syncing manifests, or proposing release versions.
