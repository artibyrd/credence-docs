...
export const DOCS_REGISTRY = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "blog/case-study-dual-tier-finops", title: "Case Study: Cutting Cloud Costs 83% with Dual-Tier Ingress Gating", path: "blog/case-study-dual-tier-finops.md", desc: "Bicameral shadow audit proving 82.7% token reduction and $0.00 Tier 0 bypass on clean investigative news.", keywords: ["blog", "casestudy", "finops", "dual-tier", "cost", "tokens", "gating", "savings"] },
