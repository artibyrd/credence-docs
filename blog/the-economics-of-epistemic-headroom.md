...
```mermaid
flowchart LR
    G1["1. Full Inference (>30% Headroom)<br/>Gemini 3.7 Flash + Thinking"] --> G2["2. Soft-Throttle (<20% Headroom)<br/>Downshift to Gemini 2.0 Flash-Lite"]
    G2 --> G3["3. Circuit Breaker (100% Budget or Brake)<br/>Offline Structural Heuristics ($0)"]
```
